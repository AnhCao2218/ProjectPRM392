package com.caodnhe150776.myproject.Service;
...
import com.caodnhe150776.myproject.activity.MainActivity2;
...
public class FirebaseMessagerReceiver extends FirebaseMessagingService {
    ...
    private void showNotification(String title, String body) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel notificationChannel = new NotificationChannel(channelId, "my_project", NotificationManager.IMPORTANCE_HIGH);
    ...
    private RemoteViews customView(String title, String body) {
        ...
        remoteViews.setImageViewResource(R.id.imgnoti, R.drawable.ic_cloud_24);
        return remoteViews;
    }
}
