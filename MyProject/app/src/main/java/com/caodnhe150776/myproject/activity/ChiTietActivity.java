...
public class ChiTietActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FrameLayout frameLayoutgiohang= findViewById(R.id.framelayout);
    ...
    private void themGioHang() {
        if (Utlis.manggiohang.size() > 0) {
            ...
            for (int i = 0; i < Utlis.manggiohang.size(); i++) {
                if (Utlis.manggiohang.get(i).getIdsp() == sanPhamMoi.getId()) {
                    Utlis.manggiohang.get(i).setSoluong(soluong + Utlis.manggiohang.get(i).getSoluong());
                    Utlis.manggiohang.get(i).setGiasp(gia);
                    flag = true;
                    break;
                }
            }
